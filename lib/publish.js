module.exports.publish = (options) => {
   ...
   */
    ...
    function printComplete (response) {
      if (requestStatus.every(elem => elem === 1) && requestStatus.length === float2int(length / PAGES_CHUNK_SIZE) + 1) {
        ...
        console.log(chalk.bold.cyan(' Success [100%]. Manuscript was patched to https://bubblin.io.'))
        console.log(chalk.bold.yellow(' Login into your Bubblin Account and check `/drafts` folder to preview. 💝'))
      }
    }
  }
}
